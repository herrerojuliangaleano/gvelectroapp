...
export function DashboardPage() {
  ...
  const quickAccess = useMemo(() => {
    const items: QuickAccess[] = [
      ...
      { title: 'Despachar a Chiclana', description: 'Generar remito interno desde tu sucursal.', to: '/warranties/despacho', icon: <Send />, permission: 'warranties.remitos.dispatch', tone: 'amber', group: 'Trabajo diario' },
