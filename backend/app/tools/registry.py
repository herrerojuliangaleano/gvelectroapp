...
TOOLS: dict[str, ToolDef] = {
    ...
    "cer": {
        ...
        "description": "Procesa comprobantes emitidos y recibidos de ARCA y sube resultados a Drive. Los rangos largos se resumen en tablas claras por periodo y total general.",
        "icon": "🗂️",
        "color": "#8B5CF6",
        ...
        "fields": [
            ...
            {"type": "section", "name": "_otro_rango", "label": "Seleccionar otro rango", "collapsible": True, "default_open": False, "help": "Para procesar un período distinto al flujo mensual: año completo, año pasado o un rango libre. El resultado queda en tablas por periodo y total general."},
    ...
    "gge": {
        "id": "gge",
        "name": "Generar exámenes de GFK",
        "description": "AVANZADO (solo superadmin). Genera variantes de examen de un GFK con marcas infladas, para evaluar practicantes. No es para reportar a GfK.",
        "icon": "🎓",
        "color": "#A855F7",
        "script": "scripts/Generar GFK/gge.py",
        "runner": "legacy_subprocess",
        "dangerous": True,
        "fields": [
...
TOOL_METADATA: dict[str, dict[str, Any]] = {
    ...
    "gge": {"category": "Reportes", "tags": ["GFK", "exámenes", "practicantes", "avanzado"], "recommended_device": "PC", "weight": "medio"},
