...
| GET | `/api/price-cost-updates` | Lista actualizaciones. Soporta `archive=active\|archived\|all` y `announcement_pending=true`. |
...
| POST | `/api/price-cost-updates/announcements/images` | Genera PNGs comerciales con precios nuevos seleccionados, crea lote regenerable y archiva esos cambios para anuncios. |
| GET | `/api/price-cost-updates/announcements/batches` | Lista lotes de anuncios ya generados. |
| POST | `/api/price-cost-updates/announcements/batches/{batch_id}/images` | Regenera PNGs desde un lote archivado. |
